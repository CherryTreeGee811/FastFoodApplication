...
namespace FastFoodAPI.Migrations
{
    ...
    [Migration("20250408194226_Initial")]
            ...
            modelBuilder.Entity("FastFoodAPI.Entities.TrainingAssignment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCompleted = new DateTime(2025, 1, 8, 15, 42, 25, 660, DateTimeKind.Local).AddTicks(3679)
                        },
                        new
                        {
                            EmployeeId = 1,
                            TrainingId = 2,
                            CompletedTraining = true,
                            DateCompleted = new DateTime(2025, 2, 8, 15, 42, 25, 660, DateTimeKind.Local).AddTicks(3679)
                        },
                        new
                        {
                            EmployeeId = 1,
                        ...
                        new
                        {
                            ...
                            TrainingId = 1,
                            CompletedTraining = true,
                            DateCompleted = new DateTime(2025, 3, 8, 15, 42, 25, 660, DateTimeKind.Local).AddTicks(3679)
                        },
                        new
                        {
                            EmployeeId = 11,
