    ...
    public partial class ShiftAssignmentsFix : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "JobTitles",
                columns: ["JobTitleId", "Description", "Title"],
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Stations",
                columns: ["StationId", "Description", "IsActive", "StationName"],
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Trainings",
                columns: ["TrainingId", "TrainingDescription", "TrainingName"],
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: ["Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FirstName", "JobTitleId", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "StationId", "TwoFactorEnabled", "UserName"],
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                ...
                columns: ["EmployeeId", "ShiftDate", "ShiftId"],
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                ...
                columns: ["EmployeeId", "TrainingId", "CompletedTraining", "DateCompleted"],
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "TrainingAssignments",
                columns: ["EmployeeId", "TrainingId", "DateCompleted"],
                values: ["05f5e67c-8be2-42ed-8921-37d041edce53", 3, null!]);
            ...
            migrationBuilder.InsertData(
                table: "TrainingAssignments",
                columns: ["EmployeeId", "TrainingId", "DateCompleted"],
                values: ["8279e5c9-92f0-48d3-b518-c2b08d1692fb", 5, null!]);
